                                    ...
                                    <div className="flex-1 min-w-0">
                                       <div className="flex items-center gap-2 mb-0.5">
                                          ...
                                          <Badge variant="secondary" className={cn(
                                             "text-[8px] font-black uppercase py-0 px-1.5 border-white/5",
                                             action.action_type === 'payment_shortage' ? "bg-red-500/20 text-red-400" : "bg-zinc-900 text-gray-400"
                                          )}>
                                       ...
                                       {action.details?.amount && (
                                          <p className="text-[9px] text-gray-500 font-bold uppercase">
                                             Value: ETB {action.details.amount.toLocaleString()}
                                          </p>
                                       )}
                                    </div>
                     ...
                     <div className="space-y-4 animate-in fade-in">
                        <div className="grid grid-cols-2 gap-4">
                           ...
                           <div className="p-4 bg-red-500/5 border border-red-500/20 rounded-2xl">
                              <p className="text-[8px] font-black text-red-500 uppercase mb-1">Total Shortage</p>
                              <p className="text-lg font-black text-red-500 font-mono">ETB {selectedStaff?.stats?.total_shortage?.toLocaleString() || 0}</p>
                           </div>
                           <div className="p-4 bg-black/20 border border-white/5 rounded-2xl">
                              <p className="text-[8px] font-black text-gray-500 uppercase mb-1">Shortage Count</p>
                              <p className="text-lg font-black text-white font-mono">{selectedStaff?.stats?.shortages_count || 0}</p>
                           </div>
                        </div>
                     </div>
                  )}
