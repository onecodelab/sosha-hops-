  ...
  return (
    <div className={cn("flex flex-col items-center gap-6", className)}>
        ...
        {ratingData.map((item, i) => {
          ...
          return (
            ...
            >
              <div
                className={cn(
                  "relative flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl transition-all duration-300 ease-out",
      ...
      <div className="relative h-7 w-32">
        ...
        >
          <span className="text-sm font-medium text-muted-foreground uppercase tracking-widest text-[#84CC16]">Rate your experience</span>
        </div>
        ...
        {ratingData.map((item, i) => (
          ...
          >
            <span className={cn(
              ...
              displayRating === i + 1 && i >= 3 ? "text-emerald-400" : "text-foreground"
            )}>
              {item.label}
            </span>
          </div>
