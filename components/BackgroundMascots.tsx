...
import { ShieldCheck, ClipboardList, Coffee, Flame, ChefHat, BarChart3, Users, LayoutDashboard, Utensils, Bell } from 'lucide-react';
import { cn } from './ui';

export type MascotVariant = 'owner' | 'manager' | 'waiter' | 'kitchen' | 'landing';
