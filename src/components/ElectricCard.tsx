...
export type ElectricCardProps = {
    ...
    /** Card decoration variant */
    variant?: 'leafy' | 'kitchen' | 'billing';
};

/**
 * ElectricCard
 * A consolidated, highly-styled glassmorphism card with ambient glow and thematic decorations.
 */
export const ElectricCard: React.FC<ElectricCardProps> = ({
    color = "#A3E635",
    badge,
    className = "",
    children,
...
// Wrapper exports to maintain backward compatibility with zero consumer changes
export const BaroLeafyCard = (props: Omit<ElectricCardProps, 'variant'>) => (
    <ElectricCard {...props} variant="leafy" color={props.color || "#A3E635"} />
);

export const BaroKitchenCard = (props: Omit<ElectricCardProps, 'variant'>) => (
    <ElectricCard {...props} variant="kitchen" color={props.color || "#F97316"} />
);

export const BaroBillingCard = (props: Omit<ElectricCardProps, 'variant'>) => (
    <ElectricCard {...props} variant="billing" color={props.color || "#3B82F6"} />
);
